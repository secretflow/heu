...
struct convert<heu::lib::algorithms::paillier_z::SecretKey> {
  msgpack::object const &operator()(const msgpack::object &object,
    ...
    sk.lambda_ = object.via.array.ptr[0].as<heu::lib::algorithms::BigInt>();
    sk.mu_ = object.via.array.ptr[1].as<heu::lib::algorithms::BigInt>();
    sk.p_ = object.via.array.ptr[2].as<heu::lib::algorithms::BigInt>();
    sk.q_ = object.via.array.ptr[3].as<heu::lib::algorithms::BigInt>();
    sk.Init();
    return object;
  }
};
