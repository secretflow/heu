...
namespace heu::lib::algorithms::leichi_paillier::test {
  ...
  TEST_F(LEICHITest, CTSubCT) {
      std::cout<<"...CTSubCT..."<<std::endl;
  ...
  TEST_F(LEICHITest, CTMultiplyPT) {
