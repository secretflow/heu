...
bool SecretKey::operator==(const SecretKey &other) const {
    return pub_key_ == other.pub_key_ && p_ == other.p_ && q_ == other.q_ 
           && p_square_ == other.p_square_ && q_square_ == other.q_square_ && q_inverse_ == other.q_inverse_
           && hp_ == other.hp_ && hq_ == other.hq_;
}
...
const MPInt& SecretKey::GetP() const {
    return p_;
}

const MPInt& SecretKey::GetQ() const {
    return q_;
}

const MPInt& SecretKey::GetPSquare() const {
    return p_square_;
}

const MPInt& SecretKey::GetQSquare() const {
    return q_square_;
}

const MPInt& SecretKey::GetQInverse() const {
    return q_inverse_;
}

const MPInt& SecretKey::GetHP() const {
    return hp_;
}

const MPInt& SecretKey::GetHQ() const {
    return hq_;
}

const PublicKey& SecretKey::GetPubKey() const {
    return pub_key_;
}
