...
void fpn_matrix_elementwise_multiply_pen_matrix(
    ...
    void* res_base_void, void* res_exp_void, size_t fpn_dim0,
    size_t fpn_dim1, size_t pen_dim0, size_t pen_dim1, char* n, char* g,
    char* nsquare, char* max_int, size_t encode_bitlength,
...
void obf_modular_multiplication(
    ...
    char* res_cipher, void* res_base_void, void* res_exp_void, char* n, char* g,
    char* nsquare, char* max_int, size_t cipher_bitlength,
    size_t res_bitlength, size_t vector_size, size_t device_num);
...
void decrypt(char* pen_cipher, void* pen_base_void, void* pen_exp_void,
             ...
             char* psquare, char* qsquare, char* q_inverse,
             char* hp, char* hq, size_t encode_bitlength,
             size_t cipher_bitlength, size_t vector_size,
             size_t device_num);
...
void decode_int(char* numbers_encode, void* numbers_base_void,
                ...
                size_t encode_bitlength, void* res_void,
                size_t vector_size);
