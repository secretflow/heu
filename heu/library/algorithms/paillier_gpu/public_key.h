...
template<>
struct pack<heu::lib::algorithms::paillier_g::PublicKey> {
  template<typename Stream>
  packer<Stream> &operator()(msgpack::packer<Stream> &o,
      const heu::lib::algorithms::paillier_g::PublicKey &pk) const {
...
template<>
struct convert<heu::lib::algorithms::paillier_g::PublicKey> {
  msgpack::object const &operator()(const msgpack::object &object,
      heu::lib::algorithms::paillier_g::PublicKey &pk) const {
    ...
    pk.n_ = object.via.array.ptr[0].as<heu::lib::algorithms::paillier_g::Plaintext>();
    pk.h_s_ = object.via.array.ptr[1].as<heu::lib::algorithms::paillier_g::Plaintext>();
    pk.Init();
    return object;
  }
};
