...
Encryptor::Encryptor(const std::shared_ptr<PublicKey> &pk, bool enable_cache)
    : pk_(pk), enable_cache_(enable_cache) {
...
Ciphertext Encryptor::EncryptZeroT() const { return Ciphertext(GetHr()); }
