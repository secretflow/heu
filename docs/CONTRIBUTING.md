...
> [!TIP]
>
> 关于 Python 环境初始化的相关信息，请参考 [../CONTRIBUTING.md](../CONTRIBUTING.md)。
>
...
<figure>
  <img src="images/CONTRIBUTING/preview-sitemap.png" alt="the sitemap page">
</figure>

点击一个版本即可打开对应预览，你应当能看到类似下图的页面：

<figure>
  <img src="images/CONTRIBUTING/preview-content.png" alt="the content page">
</figure>
...
|      |                                                                                                                    |
| :--- | :----------------------------------------------------------------------------------------------------------------- |
| 原文 | [**getting_started/installation**.rst](getting_started/installation.rst)                                           |
| 翻译 | [locale/en/LC_MESSAGES/**getting_started/installation**.po](locale/en/LC_MESSAGES/getting_started/installation.po) |
...
>
> <figure>
>   <img src="images/CONTRIBUTING/poedit.png" alt="screenshot of Poedit">
> </figure>
...
[references/numpy_api.rst](references/numpy_api.rst) 以及
[references/phe_api.rst](references/phe_api.rst) 包含 HEU 的 Python API 的文档。

> [!IMPORTANT]
>
> API 文档要正确渲染，**对应的 Python 模块必须在文档构建时可以正确引用。** 也就是说
> ，`from heu import ...` 不能抛出异常，意味着依赖有被安装，以及 C/C++ 模块有被构建。
...
> [!TIP]
>
> Refer to [../CONTRIBUTING.md](../CONTRIBUTING.md) for information on setting up your
> Python environment.
>
...
|              |                                                                                                                    |
| :----------- | :----------------------------------------------------------------------------------------------------------------- |
| Source texts | [**getting_started/installation**.rst](getting_started/installation.rst)                                           |
| Translations | [locale/en/LC_MESSAGES/**getting_started/installation**.po](locale/en/LC_MESSAGES/getting_started/installation.po) |
...
[references/numpy_api.rst](references/numpy_api.rst) and
[references/phe_api.rst](references/phe_api.rst) documents HEU's Python API.
